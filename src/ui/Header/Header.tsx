...
import logo from '../../assets/icons/маруся_logo.svg'
...
export const Header = () => {
  ...
  return (
    ...
    <header className="header">
      ...
      <div className={`search-wrapper ${isVisible ? 'hidden' : 'open'}`}>
        <input
      ...
      {isVisible &&
      <button className={`button-search`} onClick={(() => setIsVisible(false))}>
